...
<html>
    <head>
        <title>Willkommen bei <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.de/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Webhosting" /></a>
                </div>
                <div class="content">
                    <h1>Ihr Konto wurde erfolgreich erstellt!</h1>
                    <p>Die Website<b> <? print $host; ?></b> wurde erfolgreich auf unserem Server installiert. Bitte löschen Sie die Datei default.php aus dem <b>public_html</b> Ordner und laden Sie Ihre Website mit FTP oder dem Datei Manager hoch.</p>
                    <p>Hier ist eine Liste der Dateien im public_html Ordner:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.de/web-hosting" target="_blank">Webhosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.de/free-hosting" target="_blank">Kostenloses Hosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.de/forum" target="_blank">Support Forum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.de/" target="_blank">Client Login</a>
                </div>
                <div class="copyright">Hostinger &copy; <? print date('Y'); ?>. All rights reserved</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.de"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
